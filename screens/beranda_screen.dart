              ...
              child: Column(
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.mosque, color: Color(0xFF1B4332)),
                        ),
                        Flexible(
                          child: SingleChildScrollView(
                            ...
                            child: Container(
                              ...
                              child: const Row(
                                ...
                                children: [
                                  NavPill(label: 'BERANDA', isActive: true),
                  ...
                  Container(
                    ...
                    child: const Icon(Icons.mosque, size: 100, color: Colors.white70),
                  ),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Silaturahmi, cinta dan rasa saling urat yang transparan di Loh Bener. Menjaga amanah, mengut kedaulatan, demi kesegarahan bersama.',
                        ...
                        ElevatedButton(
                          ...
                          child: const Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [Text('Tentang SmartKas'), SizedBox(width: 8), Icon(Icons.arrow_forward, size: 16)],
                          ),
                        ),
                        const SizedBox(height: 30),
                      ],
